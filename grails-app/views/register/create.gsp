...
<html>
    ...
    <body>
        <a href="#create-register" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-register" class="content scaffold-create" role="main">
